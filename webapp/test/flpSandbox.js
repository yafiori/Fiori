		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First App",
									"targetURL": "#capfinapproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capfinapproject1-display": {
								"semanticObject": "capfinapproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cap.fin.ap.project1",
									"url": sap.ui.require.toUrl("cap/fin/ap/project1")
								}
							}
						}
					}
